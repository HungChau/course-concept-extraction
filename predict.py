...
if __name__ == "__main__":
    ...
    output_id_concept_only['doc_id'] = list(set([c[0] for c in combined_concepts]))
    ...
    with open(args.output_file, 'w') as fw:
        fw.write('doc_id\t' + str(output_id_concept_only['doc_id']))

    print('Output concepts:')
    print(output_id_concept_only['doc_id'])
